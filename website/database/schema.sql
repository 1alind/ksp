...
(
  ...
  '["S","M","L","XL"]',
  '{"S":"Height: 65cm • Width: 45cm","M":"Height: 70cm • Width: 50cm","L":"Height: 73cm • Width: 54cm","XL":"Height: 76cm • Width: 58cm"}',
...
(
  ...
  '["48 (M)","50 (L)","52 (XL)"]',
  '{"48 (M)":"Height: 72cm • Width: 50cm","50 (L)":"Height: 74cm • Width: 54cm","52 (XL)":"Height: 76cm • Width: 58cm"}',
...
(
  ...
  '["M (48)","L (50)","XL (52)"]',
  '{"M (48)":"Height: 110cm • Width: 52cm","L (50)":"Height: 112cm • Width: 56cm","XL (52)":"Height: 115cm • Width: 60cm"}',
...
-- ------------------------------------------------------------------------------
-- 5.1 Dumping default configuration for table `settings`
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 6.1 Dumping data for table `reviews`
-- ------------------------------------------------------------------------------
INSERT INTO `reviews` (`product_id`, `user_name`, `rating`, `comment`, `date`) VALUES
(2, 'Kawa Duhoki', 5, 'گەلەک دەمژمێرەکا جوانە و کوالێتیا وێ یا بێ وێنەیە! زوو گەهشت دەستێ من ل دهۆکێ.', '2026-08-15'),
(3, 'Tariq Mansoor', 5, 'عطر العود والعنبر فواح جداً وثابت على الملابس أكثر من يومين. تجربة ممتازة.', '2026-08-12'),
(1, 'Alexander Hayes', 5, 'The velvet texture and tailoring are absolute bespoke quality. Wore it to an award gala and received endless compliments.', '2026-08-10');
